...
public class Ui {
    ...
    public int loginSelect() {
        ...
        int loginWay = Integer.parseInt(sc.nextLine());
        return loginWay;
    }

    public void adminManagementMenu() {
    ...
    public int loginDistinction(int num) {
        if (num == 1) {
